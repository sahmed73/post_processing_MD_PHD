...
"""
Author: Shihab Ahmed
Created on Fri Aug 30 21:00:33 2024
...
##
# Hard Coding
N = int(sys.argv[2])  # How many leading molecules need H removed
r = int(sys.argv[3])  # remainder of H particle id upon division by 93 (PAO_radical)
