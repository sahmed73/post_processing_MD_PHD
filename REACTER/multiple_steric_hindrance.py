...
"""
Author: Shihab Ahmed
Created on Fri Feb  7 03:22:34 2025
"""
...
def calculate_gamma(pao_file, ao_file, pao_atom_idx, ao_atom_idx, r_bond=1, AO=None):
    """
    ...
    if AO=='A0002':
        print('%%%%%%%%%%',tert_butyl_h_ao)
        tert_butyl_h_ao = [30, 31, 32, 33, 34, 35, 36, 37, 38]
        print('%%%%%%%%%%',tert_butyl_h_ao)
        
    if AO=='A0005':
        print('%%%%%%%%%%',tert_butyl_h_ao)
        tert_butyl_h_ao = [31, 32, 33, 34, 35, 36, 37, 38, 39, 43, 44, 45, 46, 47, 48, 49, 50, 51]
        print('%%%%%%%%%%',tert_butyl_h_ao)
...
for i, AO in enumerate(AOs):
    ...
    steric_hindrance, pao_neighbors, ao_neighbors = calculate_gamma(
        pao_file, ao_file, pao_atom_idx, ao_atom_idx, AO=AO)
    ...
    gammas.append(steric_hindrance)
