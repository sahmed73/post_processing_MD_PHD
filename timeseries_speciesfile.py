...
directory = r'C:\Users\arup2\OneDrive - University of California Merced\Desktop\LAMMPS\Base_Oil\PAO4\20_PAO4_80_O2_6A_Soria\Onset'

sim_dir = ['\\Sim-1']#,'\\Sim-2','\\Sim-3']
flag = True
for sim in sim_dir:
    speciesfile = directory+sim+f'\\species_{cutoff}.out'
    if cutoff==0.30:
        speciesfile = directory+sim+'\\species.out'
