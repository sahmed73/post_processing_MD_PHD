...
### Directory ###
base_oil = 'A0002'
dirr = r"C:\Users\arup2\OneDrive - University of California Merced\Desktop\LAMMPS\borgstore\ARLOI-V1\2_ARLOI_24-08-29--00-27-52\20_PAO-OH_15_{}\Production\Sim-3".format(base_oil)
...
bfp.expression_selector(neighbours, atomtypes,atomsybols='HCO',file=exp_file,heading=dirr)
