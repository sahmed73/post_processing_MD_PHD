# -*- coding: utf-8 -*-
"""
Created on Thu Jun  8 17:14:37 2023
...
import random
#%%
directory = r'C:\Users\arup2\OneDrive - University of California Merced\Desktop\LAMMPS\Antioxidants\ABCDE\D\D_300_O2\Onset'
...
for sim in ['\\Sim-1','\\Sim-2','\\Sim-3']:
    ...
    pickle_path = d + '\\bonds.pickle'
    atominfo = bfp.loadpickle_or_execute(pickle_path, bfp.get_neighbours, bfpath)
