...
baseoil = 'PAO_Radical'
location = r'C:\Users\arup2\OneDrive - University of California Merced\Desktop\LAMMPS\Base_Oil\PAO_Radical\20_PAO_Radical_20_A_Kowalik\Onset'
...
df = pd.DataFrame()
for sim in sim_dir:
    spec       = species[sim].loc[baseoil_formula[baseoil]]
