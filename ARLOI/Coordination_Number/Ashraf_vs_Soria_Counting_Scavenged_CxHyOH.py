...
"""
Author: Shihab Ahmed
Created on Tue Oct 29 03:38:31 2024
"""
...
ax.plot(scavenged, label='Soria C/H/O/N/S/Si')
...
### Directory ###
directory = r"C:\Users\arup2\OneDrive - University of California Merced\Desktop\LAMMPS\borgstore\ARLOI\ARLOI-V1\8_ARLOI_Down_to_300K\A0001\Production\Sim-2_RR=4"
filename  = "\\bonds.out"
bondfile = directory+filename
atominfo = bfp.parsebondfile(bondfile, mtypes=True)
...
ax.plot(scavenged, label='Ashraf C/H/O')
ax.set_xlabel("Time (ps)")
ax.set_ylabel("Number of scavenged radicals")
